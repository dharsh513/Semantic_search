...
```
  ...
  Storage              │  rag/store.py — SQLite                   │
                       ...
                       │  searches (history snapshots) · chat      │
                       └──────────────────────────────────────────┘
```
...
Runs 155 checks over the whole stack — XML parsing, chunking, MeSH extraction,
...
[15] v1.0.0 database migration           ...  7 passed
[16] Static assets                       ... 12 passed
  155 passed, 0 failed
```
